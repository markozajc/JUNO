...
class UnoUtilsTest {
	...
	void testAnalyzeColors() {
		UnoCard[] cards = new UnoCard[] {
				/* Red */ new UnoNumericCard(UnoCardColor.RED, 0),
				/* Red */ new UnoNumericCard(UnoCardColor.RED, 1),
				/* Red */ new UnoNumericCard(UnoCardColor.RED, 2),
				/* Red */ new UnoNumericCard(UnoCardColor.RED, 3),
				/* Red */ new UnoNumericCard(UnoCardColor.RED, 4),
				// Red x 5
				...
				/* Blue */ new UnoNumericCard(UnoCardColor.BLUE, 0),
				/* Blue */ new UnoNumericCard(UnoCardColor.BLUE, 1),
	...
	void testGetColorCards() {
		UnoCard[] cards = new UnoCard[] {
				/* 0 Red */ new UnoNumericCard(UnoCardColor.RED, 0),
	...
	void testGetActionCards() {
		UnoCard[] cards = new UnoCard[] {
				/* 0 Reverse */ new UnoActionCard(UnoCardColor.RED, UnoAction.REVERSE),
	...
	void testGetNumberCards() {
		UnoCard[] cards = new UnoCard[] {
				/* 0 3 */ new UnoNumericCard(UnoCardColor.RED, 3),
				/* 1 3 */ new UnoNumericCard(UnoCardColor.RED, 3),

				/* 2 6 */ new UnoNumericCard(UnoCardColor.GREEN, 6),
				/* 3 6 */ new UnoNumericCard(UnoCardColor.GREEN, 6),

				/* 4 9 */ new UnoNumericCard(UnoCardColor.BLUE, 9),
				/* 5 9 */ new UnoNumericCard(UnoCardColor.BLUE, 9),
	...
	void testFilterKind() {
		UnoCard[] cards = new UnoCard[] {
				/* 0 Numeric */ new UnoNumericCard(UnoCardColor.RED, 0),
